//
// file: img_refract_NoMRT_NoDB.fx
// version: v1.5
// author: Ren712
//
...
float4 PixelShaderFunctionSM2NoDB(PSInput PS) : COLOR0
{
    ...
    // include fog fading effect
    float3 applyFade = 1 - MTAApplyFade(PS.WorldPos, PS.CameraPosition);
...
// Techniques
//--------------------------------------------------------------------------------------
technique dxDrawImage4D_ref_PS3_NoMRT_NoDB
{
  pass P0
  {
    ZEnable = true;
...
technique dxDrawImage4D_ref_PS2_NoMRT_NoDB
{
  pass P0
  {
    ZEnable = true;
