...
Updater.register{
	...
	func = function()
		...
		Updater.queueTableRecreate(SerialsTable)
		Updater.queueTableRecreate(MapsTable)
		Updater.queueTableRecreate(AliasesTable)
		Updater.queueTableRecreate(BestTimesTable)
		Updater.queueTableRecreate(RatesTable)
		Updater.queueTableRecreate(ProfilesTable)
		Updater.queueTableRecreate(Teams.TeamsTable)
		Updater.queueTableRecreate(SettingsTable)
		Updater.queueTableRecreate(PlayersTable)
	end
}
